...
.text
.p2align 4,,15
.globl	copp_make_fcontext_v2
.def	copp_make_fcontext_v2;	.scl	2;	.type	32;	.endef
.seh_proc	copp_make_fcontext_v2
...
.seh_endprologue
    ...
    /* will be entered after copp_jump_fcontext_v2() first time */
    movq  %rcx, 0x118(%rax)
...
finish:
    ...
    /* already reserved by copp_make_fcontext_v2() */
    /* exit code is zero */
    xorq  %rcx, %rcx
    /* exit application */
    call  _exit
